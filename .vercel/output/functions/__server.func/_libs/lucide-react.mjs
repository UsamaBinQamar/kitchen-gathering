...
const BookmarkPlus = createLucideIcon("bookmark-plus", __iconNode$A);
...
const ChefHat = createLucideIcon("chef-hat", __iconNode$y);
...
const Leaf = createLucideIcon("leaf", __iconNode$m);
