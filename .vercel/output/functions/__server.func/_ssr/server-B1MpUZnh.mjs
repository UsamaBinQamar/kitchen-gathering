...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-1YM2N-g_.mjs");
...
const manifest = {
  "32564ba405604316c491038c9a78659715f7f484e08cef94371ce74878c414b1": {
    functionName: "listActivityForUser_createServerFn_handler",
    importer: () => import("./admin-activity.functions-BwiNZfLJ.mjs")
  },
  "536051deeb82ee0616975a95d710db802db8d4816879a206a06584714b2edbe3": {
    functionName: "setAdminRole_createServerFn_handler",
    importer: () => import("./admin-profiles.functions-CkzAW1m0.mjs")
  },
  "562fd1c2cac9fe74e0cb1aad42ce696884f273ae29979a7807af32a442be9679": {
    functionName: "listProfiles_createServerFn_handler",
    importer: () => import("./admin-profiles.functions-CkzAW1m0.mjs")
  },
  "610f8f79c147f128ed099a81b5f409f8d4ab5116a165d0859c239a7883009260": {
    functionName: "shareRecipeByEmail_createServerFn_handler",
    importer: () => import("./share-email.functions-VMo0NrBW.mjs")
  },
  "6eda1e013dfbfb132fb43f7606401fcedda0bf08d7b0a8b89814d244b60e503b": {
    functionName: "toggleProfileEnabled_createServerFn_handler",
    importer: () => import("./admin-profiles.functions-CkzAW1m0.mjs")
  },
  "74741af0ab40d84144fef1f13eb863591ef9a25410c9cf055f4f58b1383e3320": {
    functionName: "parseRecipe_createServerFn_handler",
    importer: () => import("./recipe-ai.functions-DecqiMys.mjs")
  },
  "82d428b9f7c53225e7b9c9db9e2d6562f3acea716e238a002ac3f6977a64c8d4": {
    functionName: "deleteProfile_createServerFn_handler",
    importer: () => import("./admin-profiles.functions-CkzAW1m0.mjs")
  },
  "9d51a7c76989ef9def673fbd012cc1dda2da00e66ac366c4d97961a58d4a1371": {
    functionName: "updateProfile_createServerFn_handler",
    importer: () => import("./admin-profiles.functions-CkzAW1m0.mjs")
  },
  "c8e7da2243ced64ce8bed251a554ece2a86c2440f544918e0ecdeb5bea08b3e8": {
    functionName: "listRecipesForUser_createServerFn_handler",
    importer: () => import("./admin-recipes.functions-AzgT80FH.mjs")
  },
  "f6251bb76805ec4fbb5ebcda8307cd612f275d8686a621a457a96e8c21aeb0a4": {
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Cq9dAjtw.mjs").then((n) => n.w),
    import("./start-CVBklGTM.mjs"),
